...
export function SwitchGroup({ className, ...props }: Readonly<React.ComponentPropsWithoutRef<'div'>>) {
  return (
    <div
      data-slot="control"
      {...props}
  ...
  return (
    <HeadlessSwitch
      ...
      className={clsx(
        ...
        // Base styles
        'group relative isolate inline-flex h-6 w-10 cursor-default rounded-full p-[3px] sm:h-5 sm:w-8 cursor-pointer',
