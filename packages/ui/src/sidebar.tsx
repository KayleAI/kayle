...
export const SidebarItem = forwardRef(function SidebarItem(
	...
	const classes = clsx(
		...
		// Hover
		"data-[hover]:bg-zinc-950/5 data-[slot=icon]:*:data-[hover]:fill-zinc-950 data-[slot=icon]:*:data-[hover]:text-zinc-950",
		// Active
		"data-[active]:bg-zinc-950/5 data-[slot=icon]:*:data-[active]:fill-zinc-950 data-[slot=icon]:*:data-[active]:text-zinc-950",
		// Current
		"data-[slot=icon]:*:data-[current]:fill-zinc-950 data-[slot=icon]:*:data-[current]:text-zinc-950",
		// Dark mode
		"dark:text-white dark:data-[slot=icon]:*:fill-zinc-400 dark:data-[slot=icon]:*:text-zinc-400",
		"dark:data-[hover]:bg-white/5 dark:data-[slot=icon]:*:data-[hover]:fill-white dark:data-[slot=icon]:*:data-[hover]:text-white",
		"dark:data-[active]:bg-white/5 dark:data-[slot=icon]:*:data-[active]:fill-white dark:data-[slot=icon]:*:data-[active]:text-white",
		"dark:data-[slot=icon]:*:data-[current]:fill-white dark:data-[slot=icon]:*:data-[current]:text-white",
	);
