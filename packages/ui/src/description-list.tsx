...
export function DescriptionList({ className, ...props }: Readonly<React.ComponentPropsWithoutRef<'dl'>>) {
  return (
    <dl
      {...props}
      className={clsx(
...
export function DescriptionTerm({ className, ...props }: Readonly<React.ComponentPropsWithoutRef<'dt'>>) {
  return (
    <dt
      {...props}
      className={clsx(
...
export function DescriptionDetails({ className, ...props }: Readonly<React.ComponentPropsWithoutRef<'dd'>>) {
  return (
    <dd
      {...props}
      className={clsx(
