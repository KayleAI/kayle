                  ...
                  <div className="w-screen overflow-hidden rounded-tl-xl bg-zinc-900">
                    <div className="flex bg-zinc-800/40 ring-1 ring-white/5">
                      <div className="-mb-px flex text-sm font-medium leading-6 text-zinc-400">
                        ...
                        <div className="border-r border-zinc-600/10 px-4 py-2">app.js</div>
                      </div>
                    </div>
...
function HunterComponent() {
  ...
  return (
    <div className="mx-auto py-24 px-6 sm:py-32 lg:px-8">
      ...
      <div
        className="relative isolate overflow-hidden bg-zinc-900 shadow-2xl rounded-3xl lg:flex lg:gap-x-20 lg:pt-0 mt-8 mx-auto max-w-5xl"
      >
        <div className="mx-auto max-w-2xl md:mx-0 md:max-w-none">
          <div className="w-screen overflow-visible rounded-tl-xl bg-zinc-900">
            <div className="flex bg-zinc-800/40 ring-1 ring-white/5">
              <div className="-mb-px flex text-sm font-medium leading-6 text-zinc-400">
                <div
                  className="border-b border-r border-b-white/10 border-r-white/10 bg-zinc-50/5 dark:bg-zinc-950/5 py-2 px-4 text-white">
                  &nbsp;&nbsp;&nbsp;terminal
                </div>
                <div className="border-r border-zinc-600/10 py-2 px-4">api.kayle.ai</div>
              </div>
            </div>
            ...
            <div className="hidden lg:flex bg-zinc-800/40 ring-1 ring-white/5 max-w-5xl">
              <span>
                <div className="-mb-px flex text-sm font-medium leading-6 text-zinc-400">
                  <div
                    className="border-b border-r border-b-white/20 border-r-white/10 bg-zinc-50/5 dark:bg-zinc-950/5 py-2 px-4 text-white"
                  >
                    &nbsp;&nbsp;&nbsp;Enter your message:
                  </div>
                </div>
              ...
              <button id="terminal_button" onClick={handleSubmit}>
                <div className="-mb-px flex text-sm font-medium leading-6 text-zinc-400">
                  <div
                    className="border-b border-l border-b-white/20 border-l-white/10 bg-zinc-50/5 dark:bg-zinc-950/5 py-2 px-4 text-white"
                  >
                    Submit&nbsp;&nbsp;&nbsp;
                  </div>
                </div>
