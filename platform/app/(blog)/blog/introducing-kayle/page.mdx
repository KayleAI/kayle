...
**A great content moderation service should be <ins>affordable</ins>—even at much higher usage levels.**

### User experience

A commonly overlooked factor is **user experience**, which refers to the experience of several different types of users.
