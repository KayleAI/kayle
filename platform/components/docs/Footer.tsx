	...
	return (
		<div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
			...
			<div className="flex gap-4">
				<SocialLink href="https://go.kayle.ai/x" icon={XIcon}>
					Follow us on X
				</SocialLink>
				<SocialLink href="https://git.new/kayle" icon={GitHubIcon}>
					Follow us on GitHub
				</SocialLink>
				<SocialLink href="https://go.kayle.ai/discord" icon={DiscordIcon}>
