...
function Glow() {
	...
	return (
		<div className="absolute inset-0 -z-10 overflow-hidden bg-zinc-950 lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem]">
			<svg
...
export function Layout({ children }: { readonly children: React.ReactNode }) {
	return (
		<>
			...
			<div className="group absolute right-4 top-4 z-50 -m-2.5 p-2.5">
				<ThemeToggle />
			</div>
