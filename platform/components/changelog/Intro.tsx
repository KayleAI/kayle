...
import { ChangelogNewsletterForm } from "@/components/changelog/ChangelogNewsletterForm";
import { Kayle } from "@repo/icons/ui/index";

function BookIcon(props: Readonly<React.ComponentPropsWithoutRef<"svg">>) {
	return (
...
function FeedIcon(props: Readonly<React.ComponentPropsWithoutRef<"svg">>) {
	return (
		<svg viewBox="0 0 16 16" aria-hidden="true" fill="currentColor" {...props}>
			<path
				fillRule="evenodd"
	...
	return (
		<>
			<Link href="/" aria-label="Home" className={"pointer-events-auto"}>
				<Kayle className={"rounded-full object-cover size-9"} />
			</Link>
			...
			<p className="mt-4 text-sm/6 text-zinc-300">
				Moderate content autonomously with AI and focus on building the core of
				your product.
			</p>
			<ChangelogNewsletterForm />
			<div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
				<IconLink
					href="https://kayle.ai/docs"
					icon={BookIcon}
					className="flex-none"
				>
					Documentation
